...
- `API_REFERENCE.md` and `frontend/public/docs/API_REFERENCE.md` — example
  curl bodies inline the admin password. TODO Phase 3 STAB-03: refresh docs
  to reference the env-var contract instead.
