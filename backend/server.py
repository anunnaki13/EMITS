    ...
    try:
        ...
        for _, row in df.iterrows():
            ...
            biomassa_doc = {
                ...
                "shipment_code": safe_str(row.get("Shipment Code")),
                "voyage_code": safe_str(row.get("Voyage Code")),
                "lot": safe_str(row.get("Lot Suppliers", row.get("LOT"))),
                "suppliers": safe_str(row.get("Suppliers", row.get("Lot Suppliers"))),
                "shipper": safe_str(row.get("Shipper Lot", row.get("Shipper"))),
                "lot_detail": safe_str(row.get("LOT.1")),
                "tb": safe_str(row.get("TB", row.get("TB BG Biomass"))),
                "bg": safe_str(row.get("BG")),
                "biomass_type": safe_str(row.get("Biomass", row.get("TB BG Biomass"))),
                # Waktu Operasional
                "ta": safe_str(row.get("TA", row.get("TA Berthed Time"))),
                "berthed_time": safe_str(row.get("Berthed Time")),
                "commenced_unloading": safe_str(row.get("Commenced Unloading")),
                "completed_unloading": safe_str(row.get("Completed Unloading")),
                "durasi_pembongkaran_hari": safe_float(row.get("Durasi Pembongkaran (Hari)")),
                ...
                "surveyor_unloading": safe_str(row.get("Surveyor Unloading", row.get("Surveyor"))),
                # COW/ROW
                "no_cow_row": safe_str(row.get("NO.COW / ROW", row.get("NO.ROW"))),
                "tgl_terbit_cow": safe_str(row.get("Tgl Terbit COW", row.get("Tgl Terbit ROW"))),
                "lama_terbit_row": safe_str(row.get("Lama terbit Row", row.get("Lama Terbit ROW (Hari)"))),
                # COA
                "no_coa": safe_str(row.get("NO. COA")),
                "tgl_terbit_coa": safe_str(row.get("Tgl Terbit COA")),
                "durasi_terbit_coa": safe_str(row.get("DURASI TERBIT COA")),
