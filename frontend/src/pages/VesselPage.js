...
import { Ship, Plus, Search, Upload, MoreHorizontal, Edit, Trash2, Loader2, FileSpreadsheet, AlertTriangle, Eye } from "lucide-react";
...
const VesselPage = () => {
  ...
  useEffect(() => { fetchVessels(); setCurrentPage(1); }, [search]);
