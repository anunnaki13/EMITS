...
EXCLUDE=(
    ...
    # NOTE: top-level "API_REFERENCE.md" cleared 2026-05-10 by Phase-3 plan 03-03 —
    #       regenerated by scripts/regenerate_api_reference.py with ${TEST_ADMIN_PASSWORD}
    #       placeholders; no longer needs an exemption.
    # NOTE: top-level "DEPLOYMENT_GUIDE.md" cleared 2026-05-10 by Phase-3 plan 03-05 —
    #       inline adminpassword replaced with ${TEST_ADMIN_PASSWORD} placeholder;
    #       mongodb+srv URI replaced with ${MONGO_URL} placeholder; no longer needs exemption.
